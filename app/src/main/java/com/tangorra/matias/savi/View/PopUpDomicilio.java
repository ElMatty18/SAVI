...
public class PopUpDomicilio extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_up_domicilio);
        ...
        cancelar = findViewById(R.id.btnCancelarDomicilio);
    ...
    private void generarEventosBotones() {
        aceptarDomicilio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SesionManager.getUsuario().getPerfil().setDomicilio(new Domicilio(lat,lng));
                finish();
            }
        });
    ...
    private void ubicacionActual() {
        ...
        if (status == ConnectionResult.SUCCESS) {
            SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.mapDomicilio);
